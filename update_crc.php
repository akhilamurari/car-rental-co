<!DOCTYPE html>
    ...
    <body>
       <form class="modal-content animate" method="post" action="update_crc.php">
        <div class="imgcontainer">
          <!-- <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">&times;</span> -->
          <img src="img/cars2.png" alt="cars" class="cars">
        </div>
        <div class="container">
...
if ($conn->connect_error) {
 ...
 $sql = "UPDATE crc SET garage_id='$garage_id',duration_of_agreement='$duration_of_agreement',no_of_cars='$no_of_cars',revenve_from_each_garage='$revenve_from_each_garage',no_of_customers='$no_of_customers',garage_name='$garage_name'
